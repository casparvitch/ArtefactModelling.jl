...
function distancefromplane(p::PlanarShape, point::SVector{3})
    return distancefromplane(p.plane, point)
end
...
# function vertices(p::PlanarShape)
#     throw(
#         ErrorException(
#             "This function should be defined for any concrete type that is a subtype of PlanarShape",
#         ),
#     ) #don't think this function can ever be called because you can't instantiate something of PlanarShape type; it's an abstract type.
# end #don't think this function can ever be called because you can't instantiate something of PlanarShape type; it's an abstract type.
